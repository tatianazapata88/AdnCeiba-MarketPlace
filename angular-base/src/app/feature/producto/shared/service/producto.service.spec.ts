...
describe('ProductoService', () => {
  ...
  const apiEndpointProductoConsulta = `${environment.endpoint}/producto/listar`;
  ...
  it('deberia listar productos', () => {
    const dummyProductos = [
      new Producto().guardar('toyota',2021,3400000,'cali',1,'ESTA',)
    ];
...
it('deberia crear un producto', () => {
     const dummyProducto = new Producto().guardar('toyota',2021,3400000,'cali',1,'ESTA');
